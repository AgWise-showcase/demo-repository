...
dssat.expfile <- function(path_coord,pathInput, pathOutput,country, useCaseName, Crop, AOI = TRUE,filex_temp, Planting_month_date=NULL,Harvest_month_date=NULL, 
  ...
  if(AOI == TRUE){
    ...
    countryCoord <- readRDS(paste0(path_coord, "/AOI_GPS.RDS"))
    ...
    GPS_fieldData <- readRDS(paste0(path_coord, "/compiled_fieldData.RDS", sep=""))  
